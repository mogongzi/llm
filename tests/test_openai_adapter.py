from providers.openai import build_payload, map_events
...
def test_openai_map_events_sequence():
    frames = [
...
def test_openai_build_payload_without_model_omits_model_key():
    messages = [{"role": "user", "content": "Hello"}]
...
def test_openai_map_events_azure_like_stream():
