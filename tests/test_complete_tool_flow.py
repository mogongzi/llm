...
def test_tool_message_formatting():
    ...
    assert assistant_msg["content"][0]["name"] == "get_current_time"
    ...
    assert user_msg["content"][0]["content"] == "2024-01-01T12:00:00Z"
...
def test_conversation_flow():
    ...
    history.append({"role": "assistant", "content": "It is 12:00 UTC."})
